...
commit = api("POST", f"{API}/git/commits", {"message": "fix: convert keywords to string, remove theme=empty", "tree": new_tree["sha"], "parents": [remote_sha]})
